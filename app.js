...
window.onload = function() {
    ...
    document.getElementById('reset-view').addEventListener('click', function() {
        ...
        cameraRotation = { x: defaultCameraPosition.rotation.x, y: defaultCameraPosition.rotation.y };
        updateCameraPosition();
    });
    ...
    for (const [name, data] of Object.entries(planetData)) {
        ...
        // Add ring for Saturn
        if (name === 'saturn') {
            const ringGeometry = new THREE.RingGeometry(data.radius * 1.4, data.radius * 2.4, 32);
    ...
    document.getElementById('speed-slower').addEventListener('click', function() {
    ...
    document.getElementById('speed-faster').addEventListener('click', function() {
    ...
    function showInfo(title, data) {
        ...
        infoTable.innerHTML = Object.entries(data).map(([key, value]) => `
            <tr>
                <td>${key}</td>
                <td>${value}</td>
            </tr>
    ...
    function animateSun(time) {
        ...
        sunGlow2.scale.set(pulseFactor * 0.95, pulseFactor * 0.95, pulseFactor * 0.95);
        sunGlow3.scale.set(pulseFactor * 1.05, pulseFactor * 1.05, pulseFactor * 1.05);
    }
